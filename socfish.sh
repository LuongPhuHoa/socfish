...
command -v php > /dev/null 2>&1 || { echo -e "\n\e[1;31m[\033[0m-\033[1;31m] Error, php is not installed! Aborting...\033[0m"; exit; }
command -v curl > /dev/null 2>&1 || { echo -e "\n\e[1;31m[\033[0m-\033[1;31m] Error, curl is not installed! Aborting...\033[0m"; exit; }
...
command -v ssh > /dev/null 2>&1 || { echo -e "\e[1;31m[\033[0m-\033[1;31m] Error, openssh is not installed! Aborting...\033[0m"; exit; }
if [[ -e sendlink ]]; then
rm -rf sendlink
fi
...
command -v unzip > /dev/null 2>&1 || { echo -e "\e[1;31m[\033[0m-\033[1;31m] Error, unzip is not installed! Aborting...\033[0m"; exit; }
command -v wget > /dev/null 2>&1 || { echo -e "\e[1;31m[\033[0m-\033[1;31m] Error, wget is not installed! Aborting...\033[0m"; exit; }
...
printf "\e[1;31m[\033[0m-\033[1;31m] Download error... Termux, run:\e[0m\e[1;77m pkg install wget\e[0m\n"
exit 1
fi
...
printf "\e[1;31m[\033[0m-\033[1;31m] Download error... \e[0m\n"
exit 1
fi
fi
fi
